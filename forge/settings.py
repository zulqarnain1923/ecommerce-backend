...
# SECRET_KEY = 'django-insecure-twiki#zo(2nd#9uu(!0u9$qxcd8k64li3jw@j#%3(o!99((1@*'
...
#         'NAME': 'mydatabase',   # tumhara database name
#         'USER': 'postgres',        # default user
#         'PASSWORD': '1234',        # wahi password jo install ke waqt set kiya tha
#         'HOST': 'localhost',
#         'PORT': '5432',
#     }
# }
...
CORS_ALLOWED_ORIGINS=[
    ...
    'https://ecommerce-backend-production-d7a6.up.railway.app'
]
